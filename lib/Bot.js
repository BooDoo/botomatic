  ...
  var T = bot.T,
      ...
      if (bot.lyricGenre === 'rap') {
        ...
        */
        ...
        console.log("No lyric source matching lyricGenre for", bot.handle);
        return -1;
      }
