...
var updateActions = {
  "prependValue": function prependValue(target, newValue, type, join) {
    ...
    if (type === "string") {
      ...
      util.error("This shouldn't happen. (from prependValue)");
    }
  ...
  "appendValue": function appendValue(target, newValue, type, join) {
    ...
    if (type === "string") {
      ...
      util.error("This shouldn't happen. (from appendValue)");
    }
  ...
  "subtractValue": function subtractValue(target, newValue, type) {
    if (type === "string") {
      ...
      util.error("This shouldn't happen. (from subtractValue)");
    }
...
function updateProperties(req, res) {
  ...
  //util.debug(JSON.stringify(Bot.bots,null,"  "));
