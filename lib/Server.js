...
//TODO: Authenticate; move to a new Server.js?
function updateProperty(req, res, update, action, forEach, joiner) {
  ...
  if (!bot || !target || _.isFunction(target)) {
    ...
    //Here are actions that don't require any newValue and ignore the targetType:
    ...
    //Otherwise, we branch behavior based on targetType
      ...
      //Don't know what to do for targets which aren't String, Number, Array or plain Object!
