...
PromiseConfig.promiseConfigs.wordnikPhrasePres = PromiseConfig({
  ...
  processBody:  function(res) {
                  ...
                  var stripRE = /^(?:the|a|an|and|or|no[tn]?|your?|my|theirs?|ours?|his|her|in|on|very|it|it'?s|this|that|these|one|very|those|own|.+'(?:'s|re|d)||each|every|on|of|be|was|re|were)$/ig;
