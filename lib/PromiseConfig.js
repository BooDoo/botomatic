...
//TODO:? Replace these PromiseConfig constructors with _.defaults(target, promiseDefaults)
PromiseConfig.cache.twitterSearch = PromiseConfig({
  handle:       "twitterSearch",
  processBody:  function(body) {
                  var results = body.results;
                  return _.each(results, function(el, ind, arr) {
                    return el.text;
                  });
                }
  //validate:   function(error, response, body)
